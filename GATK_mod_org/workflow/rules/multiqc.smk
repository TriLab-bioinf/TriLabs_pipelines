...
rule multiqc:
    input: 
        ...
        i4 = expand("results/4-recal/{s}.grp", s = samples) if config["recalibration"] == True else [],
        i5 = expand("results/5-recal/{s}.recal.bam", s = samples) if config["recalibration"] == True else [],
