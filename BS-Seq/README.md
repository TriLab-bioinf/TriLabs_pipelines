# How to run the BS-Seq pipeline 

**Figure 1:** Schematic representation of the Snakemake BS-Seq pipeline 
![](data/workflow.png)

## Running the BS-Seq pipeline in Biowulf

### 1- Go the the BS-Seq folder and within the config directory do the following:
