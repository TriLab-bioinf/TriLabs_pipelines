...
rule trimming_fastp:
    ...
    params:
        par=f"""--trim_poly_x --poly_x_min_len 10 --qualified_quality_phred 20 --length_required 40 --adapter_fasta {config['adapters']} --cut_right --cut_right_mean_quality 20 --cut_right_window_size 5 --n_base_limit 2 """,
